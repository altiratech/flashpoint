...
- The follow-up image/UX polish is now pushed and deployed on `main`.
- Northern Strait hero cues use newer U.S./domestic raster assets where available, stale generated SVG/fallback art is demoted when real images exist, and first-time navigation/copy density is simplified.
