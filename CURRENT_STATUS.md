...
Current state:
- `main` is pushed to `origin/main`; latest hardening commits are `ce18bac` (deploy verification evidence), `0e54056` (deploy verification run summary), and `ba0f591` (diagnostic retention policy).
