...
Current state:
- `main` is pushed to `origin/main`; latest hardening commits are `1a402bd` (remote telemetry verifier), `3a0107f` (client telemetry timestamp fix), and `c9a2f6f` (fresh telemetry gate inside deployed smoke).
