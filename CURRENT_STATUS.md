...
- Fresh 2026-05-18 local browser proof refresh passed under cached Node 22: desktop and 390px mobile full-run smokes in `output/playwright-2026-05-18-refresh-*`, with desktop report, mobile selected-decision, and mobile report screenshots inspected.
